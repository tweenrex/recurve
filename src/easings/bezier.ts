import { abs } from '../internals/math';
import { epsilon } from '../internals/constants';
...
export const cubicBezier = (cx1: number, cy1: number, cx2: number, cy2: number, maxIterations: number = 19) => {
